...
> **更新节奏**：每 10 轮更新一次（首次写于第 242 轮末）。死代码复查每 5 轮一次（最近一次：第 242 轮，19 → 3）。
...
| G2 纸面 200 seed | 🟡 | **300 dpi ✅ `PASS 200/200`**（1245.4 s、exit 0）；**600 dpi 无最终判决**，且用户已明示 600 dpi 非必要 |
| G3 缺页/乱序/重复 | ✅ | — |
